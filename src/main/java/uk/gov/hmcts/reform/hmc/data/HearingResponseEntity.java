...
public class HearingResponseEntity extends BaseEntity implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "hearing_response_id_seq")
    ...
    @OneToMany(mappedBy = "hearingResponse", fetch = FetchType.EAGER, cascade = CascadeType.ALL)
    @JsonSerialize
